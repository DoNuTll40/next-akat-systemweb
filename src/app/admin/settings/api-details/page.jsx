...
export default function Page() {
  ...
  return (
    <div className="bg-white p-4 rounded-xl shadow-sm select-none">
      ...
      <div>
        <a href="https://uat-provider.id.th//oauth/redirect?client_id=cc7caf68-1df5-4e6e-ab51-6902ff3b0608URRovaPpiHITgxSgDbbPOYWHHJu&redirect_uri=https://akathos.moph.go.th/hospital/admin/settings/api-details&response_type=code">test</a>
        <p>123456</p>
      </div>
    </div>
  );
