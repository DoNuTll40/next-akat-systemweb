...
export default function layout({children}) {
  ...
  return (
    <div className="flex justify-center w-full top-0 items-center min-h-screen px-4 py-4 bg-[url('https://5.imimg.com/data5/SELLER/Default/2021/8/LR/AP/SW/6976612/hospital-wallpaper.jpg')] bg-center bg-cover relative">
